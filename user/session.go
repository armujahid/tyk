...
type AccessDefinition struct {
	...
	EnableAllowList      bool                           `json:"enable_allow_list" msg:"enable_allow_list"`
	FieldRestrictionList []graphql.FieldRestrictionList `json:"field_restriction_list" msg:"field_restriction_list"`
